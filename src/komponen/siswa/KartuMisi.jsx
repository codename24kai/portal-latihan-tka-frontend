...
import { formatDuration } from '@/utilitas/formatWaktu';
...
export default function MissionCard({ exam, onStart, isPractice = false }) {
  ...
  // Navigasi routing seragam mengarah ke pra-simulasi
      ...
      <div className="p-8">
        ...
        <div className="flex flex-wrap items-center gap-6 mb-8">
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
            ...
            <span className="text-xs font-black text-slate-600 dark:text-slate-300 uppercase tracking-widest">{exam.totalQuestions || exam.questionCount || 0} Soal</span>
          </div>
        </div>
        ...
        {isLocked ? (
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <div className="flex-1 w-full p-4 bg-teal-50 dark:bg-teal-900/10 border border-teal-100 dark:border-teal-900/30 rounded-2xl flex items-center justify-between">
              ...
              <span className="text-2xl font-black text-teal-600">{exam.score || 0}</span>
            </div>
            <button
          ...
          <button
            ...
            onClick={handleNavigation}
            className="w-full h-16 flex items-center justify-center gap-3 py-4 text-white font-black text-sm uppercase tracking-[0.2em] rounded-2xl shadow-xl transition-all duration-300 hover:scale-[1.02] active:scale-95 bg-gradient-to-r from-orange-500 to-orange-600 shadow-orange-200/50"
          >
