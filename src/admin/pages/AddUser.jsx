      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">
            {isEdit ? `Memperbarui informasi akun ID: #${id}` : 'Daftarkan akun guru atau siswa ke dalam sistem'}
          </p>
        </div>
      </div>
              ...
              <div className="space-y-3">
                ...
                <Dropdown
                  ...
                  options={[
                    ...
                    { value: 'teacher', label: 'Admin / Guru' }
                  ]}
                  fullWidth
                />
              </div>
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-8 md:gap-14">
               <div className="flex flex-col items-center md:items-start min-w-[120px]">
                  ...
                  <div className="flex items-center gap-2">
                     ...
                     <span className="text-xl font-black text-white italic tracking-tighter leading-none uppercase">{formData.role === 'student' ? 'Siswa' : 'Guru / Admin'}</span>
                  </div>
               </div>
