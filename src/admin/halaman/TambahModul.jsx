              ...
              <div className="flex items-center gap-4 mb-4">
                <button
                  ...
                  className={`flex-1 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all border ${
                    uploadMode === 'url' ? 'bg-indigo-600 text-white border-indigo-600 shadow-lg shadow-indigo-600/20' : 'bg-transparent text-slate-400 border-slate-100 dark:border-slate-700 hover:bg-slate-50'
                  }`}
                >
                  Link URL
                </button>
                <button
                  ...
                  className={`flex-1 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all border ${
                    uploadMode === 'file' ? 'bg-emerald-600 text-white border-emerald-600 shadow-lg shadow-emerald-600/20' : 'bg-transparent text-slate-400 border-slate-100 dark:border-slate-700 hover:bg-slate-50'
                  }`}
                >
                  Upload File
                </button>
      ...
      <div className="mt-12 w-full">
         <div className="bg-slate-900/95 dark:bg-slate-800/95 backdrop-blur-xl border-t-4 border-indigo-500 rounded-[2.5rem] px-8 md:px-12 py-8 shadow-xl flex flex-col md:flex-row items-center justify-between gap-8 overflow-hidden relative">
            ...
            <div className="flex items-center gap-2 md:gap-4 w-full md:w-auto justify-center md:justify-end">
                <button onClick={() => navigate('/admin/modules')} className="px-6 py-4 text-slate-400 hover:text-white text-[10px] font-black uppercase tracking-widest transition-colors mr-2 md:mr-6">Batal</button>
