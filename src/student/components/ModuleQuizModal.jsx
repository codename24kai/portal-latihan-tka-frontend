                    ...
                    {userAnswers.filter(ans => !ans.isCorrect).map((ans, i) => {
                      ...
                      return (
                        <div key={i} className="p-5 bg-rose-50/50 dark:bg-rose-950/10 border border-rose-100 dark:border-rose-900/20 rounded-2xl space-y-2">
                          <p className="text-xs font-bold text-slate-700 dark:text-slate-300"><MathRenderer text={q.text} /></p>
                          <div className="flex items-center gap-2 text-[10px] font-black uppercase">
                            <span className="text-rose-500">Pilihanmu: <MathRenderer text={q.options[ans.selectedOption]} /></span>
                            <span className="text-slate-300">|</span>
                            <span className="text-emerald-500">Jawaban Benar: <MathRenderer text={q.options[q.correctIndex]} /></span>
                          </div>
                        </div>
                      );
                    })}
