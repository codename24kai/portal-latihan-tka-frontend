  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-slate-900/40 backdrop-blur-xl">
      <motion.div 
        ...
        className="relative w-full max-w-2xl bg-white dark:bg-slate-900 rounded-[3rem] shadow-2xl overflow-hidden flex flex-col items-center p-8 md:p-12 text-center"
      >
        ...
        {/* Steps Grid */}
        <div className="grid grid-cols-1 gap-4 w-full mb-10 relative z-10">
          {steps.map((step, idx) => (
            <motion.div 
              key={idx}
