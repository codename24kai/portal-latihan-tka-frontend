        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-sm border border-slate-100 dark:border-slate-700 flex flex-col items-center">
            ...
            <div className="relative mb-6 group">
              <div className={`w-32 h-32 rounded-3xl border-4 border-white dark:border-slate-700 shadow-xl flex items-center justify-center text-white overflow-hidden transition-all duration-500 ${!currentUser?.profile_pic && (isMale
